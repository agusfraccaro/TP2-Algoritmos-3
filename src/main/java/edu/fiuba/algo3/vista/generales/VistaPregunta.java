package edu.fiuba.algo3.vista.generales;

import edu.fiuba.algo3.controlador.generales.ControladorEnviarRespuesta;
import edu.fiuba.algo3.controlador.informacionJuego.ControladorMostrarInfoBonus;
import edu.fiuba.algo3.controlador.informacionJuego.ControladorMostrarInfoPreguntas;
...
import edu.fiuba.algo3.vista.fabricas.FabricaBotonBonus;
import edu.fiuba.algo3.vista.fabricas.FabricaPanelOpciones;
import edu.fiuba.algo3.vista.temporizador.Temporizador;
...
public class VistaPregunta {
    ...
    public VistaPregunta(Kahoot kahoot, Stage stage){
        this.kahoot = kahoot;
        this.stage = stage;
    }
