...
import edu.fiuba.algo3.vista.generales.VistaFinDelJuego;
...
public class ControladorEnviarRespuesta implements EventHandler<ActionEvent> {
    ...
    private final VistaPregunta vista;
    private final int cantidadRespuestas;
    private final Stage stage;
    private final ObservableList<Node> botones;
    private int extra = 1;

    public ControladorEnviarRespuesta(Kahoot kahoot, VistaPregunta vista, Stage stage, int cantidadRespuestas, ObservableList<Node> buttons){
        this.kahoot = kahoot;
        this.vista = vista;
